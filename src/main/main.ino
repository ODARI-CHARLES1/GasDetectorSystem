...
sim800.println("AT+CMGS=\"+254111639505\"");
delay(2000);

sim800.print("EMERGENCY ALERT: Methane (CH4) gas leakage has been detected by the Smart Gas Monitoring System. Methane is a highly flammable gas and may cause a serious fire or explosion hazard. Immediate inspection of the area is required. Ensure proper ventilation and avoid open flames or electrical sparks.");
...
sim800.print("WARNING: Smoke has been detected by the Smart Gas and Fire Monitoring System. The presence of smoke may indicate a potential fire hazard or overheating equipment. Please inspect the environment immediately and follow safety procedures.");
